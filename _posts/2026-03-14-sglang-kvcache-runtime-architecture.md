...
![SGLang 在早期 blog 中展示的共享前缀 workload 示例](assets/sglang-prefix-sharing-workloads.jpg)
...
![SGLang 早期关于 RadixAttention 的概览图](assets/sglang-radixattention-overview.jpg)
...
![SGLang v0.4 的 cache-aware load balancer 示意图](assets/sglang-cache-aware-load-balancer.png)
...
![HiCache 总体 workflow 示意图](assets/sglang-hicache-overview.png)
...
- 仓库：`sgl-project/sglang` · commit：`0de0d74` · [查看](https://github.com/sgl-project/sglang/commit/0de0d74)

### 源码

- [1] radix_cache.py（RadixAttention 核心数据结构）](https://github.com/sgl-project/sglang/blob/main/python/sglang/srt/mem_cache/radix_cache.py)
- [2] base_prefix_cache.py（Prefix Cache 抽象接口）](https://github.com/sgl-project/sglang/blob/main/python/sglang/srt/mem_cache/base_prefix_cache.py)
- [3] schedule_policy.py（Cache-Aware 调度策略）](https://github.com/sgl-project/sglang/blob/main/python/sglang/srt/managers/schedule_policy.py)
- [4] hiradix_cache.py（HiCache 分层缓存实现）](https://github.com/sgl-project/sglang/blob/main/python/sglang/srt/mem_cache/hiradix_cache.py)

### 博客

- [5] Fast and Expressive LLM Inference with RadixAttention and SGLang（LMSYS）](https://lmsys.org/blog/2024-01-17-sglang/)
- [6] SGLang v0.4：Cache-Aware Load Balancing（LMSYS）](https://lmsys.org/blog/2024-12-04-sglang-v0-4/)

### 文档

- [7] HiCache System Design and Optimization（SGLang 官方）](https://docs.sglang.ai/advanced_features/hicache.html)
